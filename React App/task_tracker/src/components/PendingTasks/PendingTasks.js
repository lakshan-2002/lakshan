...
function PendingTasks() {
    ...
    const tasks = [
        { title: "Build Navbar", description: "Implement navbar.", status: "Pending", priority: "High", dueDate: "2025-01-05" },
        { title: "Create Login Page", description: "Design login page.", status: "Pending", priority: "Medium", dueDate: "2025-01-10" },
        { title: "Set Up Database", description: "Configure MySQL.", status: "Pending", priority: "Low", dueDate: "2023-12-25" },
        { title: "Implement Authentication", description: "Add authentication logic.", status: "Pending", priority: "High", dueDate: "2024-01-15" },
      ];
